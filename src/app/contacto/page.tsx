          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="flex items-center gap-4">
                  {/* <WhatsApp className="w-6 h-6 text-primary" /> */}
                  <div>
                    <p className="font-semibold">WhatsApp</p>
                    <a href={`https://wa.me/${siteConfig.contact.whatsapp.replace(/\D/g, '')}`} className="hover:text-primary">
            ...
            <div className="bg-primary-lighter rounded-xl p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="bg-primary text-white px-6 py-2 rounded-lg font-medium hover:bg-primary-dark transition text-center"
                >
                ...
                <a
                  ...
                  className="bg-accent text-white px-6 py-2 rounded-lg font-medium hover:bg-primary transition text-center"
                >
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="bg-primary text-white rounded-xl p-8 text-center">
            ...
            <button className="bg-white text-primary px-8 py-3 rounded-lg font-medium hover:bg-gray-100 transition">
              Agendar Cita
            </button>
          </div>
        </div>
